...
namespace ClientWebSocket.Pipeline.Helpers
{
    public static class MemoryOwner
    {
        ...
        /// </summary>
        public static IMemoryOwner<char> DecodeOwned(this ReadOnlyMemory<byte> bytes, Encoding encoding = null)
        {
        ...
        /// </summary>
        public static IMemoryOwner<byte> EncodeOwned(this string value, Encoding encoding = null)
        {
            if (encoding == null) encoding = Encoding.UTF8;
